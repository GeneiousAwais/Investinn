<div class="card">
    <div class="card-header">
        <div class="card-body">
                <form class="row g-3 needs-validation" id="projectsSDGForm" novalidate method="POST" action="{{ route('project-sdgs.store')}}?project_id={{isset($project) ? $project->id : ''}}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-label-group in-border">
                            ...
                            <label for="sdgID" class="form-label fs-5 fs-lg-1">SDG <span class="text-danger">*</span></label>
                    ...
                    <div class="col-12 text-end">
                        <input type="hidden" class="form-control" id="form_info" name="form_info"  value="projects_sdgs">
