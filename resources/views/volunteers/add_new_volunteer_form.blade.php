            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane {{ request()->query('tab') == 'personaldetails' || request()->query('tab') == 'personaldetails_edit' ? 'active' : '' }} " id="personalDetail" role="tabpanel">
                        @include('volunteers.add_volunteer')
                    </div>

                     <div class="tab-pane {{ request()->query('tab') == 'otherdetails' ? 'active' : '' }} " id="otherDetails" role="tabpanel" >
                        @include('volunteers.other_details')
                    </div>

                    <div class="tab-pane" id="changePassword" role="tabpanel">
                        @include('volunteers.change_password')
                    </div>
                </div>
            </div>
        </div>
...
<div id="volunteerModal" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
