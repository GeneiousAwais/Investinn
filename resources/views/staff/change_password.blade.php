<form class="row g-3 needs-validation" id="projectsDetailsForm" novalidate method="POST" action="{{ route('users.update',isset($user_info) ? $user_info->id : '') }}">
    ...
    <div class="col-md-6 col-sm-12">
        <div class="form-label-group in-border">
            ...
            <label for="investorPassword" class="form-label fs-5 fs-lg-1">New Password</label>
    ...
    <div class="col-md-6 col-sm-12">
        <div class="form-label-group in-border">
            ...
            <label for="investorConfirmPassword" class="form-label fs-5 fs-lg-1">Confirm Password</label>
            <div class="invalid-tooltip">
    ...
    <div class="col-12 text-end">
        <input type="hidden" class="form-control" id="form_info" name="form_info"  value="changePasswordStaff">
