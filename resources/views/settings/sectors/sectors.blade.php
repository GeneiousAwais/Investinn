...
@include('components.flash_message')
    <div class="row">
        ...
        @if (isset($sector))
            @include('settings.sectors.edit_sector')
        @else
                @include('settings.sectors.add_sector')
        @endif
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Sectors</h4>
                ...
                <div class="card-body">
                    <table id="sectors-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
