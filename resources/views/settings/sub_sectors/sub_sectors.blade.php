...
@include('components.flash_message')
    <div class="row">
        ...
        @if (isset($subSector))
            @include('settings.sub_sectors.edit_sub_sector')
        @else
                @include('settings.sub_sectors.add_sub_sector')
        @endif
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Sub Sectors</h4>
                ...
                <div class="card-body">
                    <table id="sub-sector-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#sub-sector-data-table').DataTable({
                retrieve: true,
                processing: true,
                language: {
                    search: "",
