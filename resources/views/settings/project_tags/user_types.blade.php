...
@section('content')
    <div class="row">
        ...
        @if (isset($userType))
            @include('settings.user_types.edit_user_types')
        @else
            @include('settings.user_types.add_user_types')
        @endif
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">User Types</h4>
                ...
                <div class="card-body">
                    <table id="user_types-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#user_types-data-table').DataTable({
                retrieve: true,
                processing: true,
                language: {
                    search: "",
