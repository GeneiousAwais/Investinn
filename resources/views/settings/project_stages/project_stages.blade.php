...
@include('components.flash_message')
    <div class="row">
        ...
        @if (isset($projectStage))
            @include('settings.project_stages.edit_project_stages')
        @else
            @include('settings.project_stages.add_project_stages')
        @endif
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Project Stages</h4>
                ...
                <div class="card-body">
                    <table id="project_stages-data-table" class="table table-bordered table-striped align-middle table-nowrap mb-0"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>ID</th>
...
@push('footer_scripts')
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('#project_stages-data-table').DataTable({
                retrieve: true,
                processing: true,
                language: {
                    search: "",
                ...
                pageLength: 10,
                scrollX: true,
                ajax: "{{ route('project-stages.index') }}",
                columns: [{
                        data: 'id',
                        name: 'id',
                        width: "5%"
